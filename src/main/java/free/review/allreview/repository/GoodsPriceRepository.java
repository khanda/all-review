...
//    @Query("SELECT u FROM GoodsPrice u WHERE u.goodsId = :#{#goodsId} AND u.date = :#{#date}")
//    Collection<GoodsPrice> findByGoodsIdAndDate(@Param("goodsId") Long goodsId, @Param("date") String date);
}
